...
```
useark_bn254::Bn254;  
useark_circom::CircomBuilder;  
useark_circom::CircomConfig;  
useark_groth16::{Groth16, prepare_verifying_key};  
useark_serialize::CanonicalSerialize;  
useark_snark::SNARK;  
userand::rngs::StdRng;  
userand::SeedableRng;  
...
letmut builder =CircomBuilder::new(cfg);  
...
letmut rng:StdRng=SeedableRng::from_seed([0;32]);  
let pk =  
...
letmut public_inputs_serialized =Vec::new();  
...
Recall that this creates a proof that the prover knows a factorisation, in this case of the 5th Fermat number (_2 32 + 1 = 4294967297 = 641 * 6700417_).
